...
#chúng ta sẽ phải chuyển hình ảnh sang BGR (Blue,green,Red)
...
imgCheck = face_recognition.load_image_file("pic/ronaldo.jpg")
...
cv2.rectangle(imgElon,(faceloc[3],faceloc[0]),(faceloc[1],faceloc[2]),(255,0,255),2)#vẽ hình ảnh
